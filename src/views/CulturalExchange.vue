<template>
  <div>
    <section class="page-banner">
      <div class="page-banner-bg" style="background-image: url('https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=international%20cultural%20exchange%20diverse%20people%20together&image_size=landscape_16_9')"></div>
